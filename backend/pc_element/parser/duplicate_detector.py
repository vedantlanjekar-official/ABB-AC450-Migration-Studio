"""
duplicate_detector.py - Stage 9: Deduplication of extracted PC Element I/O objects.

Primary Key: (io_family, card_number, channel_number, device_tag).

Every distinct hardwired address is retained — including attribute variants
(KEY vs KEY:SELECTED vs KEY:MAN) and different card/channel combinations.
Only exact duplicate extractions of the same address are removed.
"""
...
class DuplicateDetector:
    """Detects and removes exact-duplicate I/O reference objects."""
